...
<x-app-layout>
    <div class="py-10">
        <div class="max-w-4xl mx-auto">
            ...
            <h1 class="text-2xl font-bold mb-6">Tambah Tag</h1>

            <div class="bg-white shadow rounded p-6">
                <form action="{{ route('admin.tag.store') }}" method="POST" class="space-y-5">
                    @csrf

                    <div>
                        <label class="block font-semibold mb-1">Nama Tag</label>
                        <input type="text" name="tags_name" class="w-full border p-2 rounded" required>
                    </div>
